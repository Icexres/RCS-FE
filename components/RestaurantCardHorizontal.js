const RestaurantCardHorizontal = ({ restaurant, gradientFrom, gradientTo }) => {
  return (
    <article className="w-[85vw] max-w-[320px] sm:w-72 lg:w-80 shrink-0 snap-start overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm flex flex-col">
      <div className={`flex h-28 sm:h-32 bg-linear-to-r ${gradientFrom} ${gradientTo}`} />

      <div className="flex min-h-55 flex-col grow p-4 sm:p-5">
